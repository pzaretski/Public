...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values=class_counts.values, names=class_counts.index, title='Success Rate for ' + entered_site)
        return fig
# TASK 4:
...
def get_scatter_plot(entered_site, entered_payload):
    if entered_site == 'ALL':
        ...
        fig = px.scatter(
            ...
            title='Payload Mass vs. Launch Outcome for All Launch Sites'
        )
        return fig
    else:
        filtered_df = spacex_df[
